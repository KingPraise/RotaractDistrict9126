...
import { Sparkles, Send, CheckCircle2, AlertCircle, HeartHandshake, Users, ShieldCheck, ArrowRight } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            <div className="glass-panel rounded-3xl p-6 sm:p-10 shadow-2xl border border-white/15 relative overflow-hidden">
              ...
              <p className="text-xs text-slate-400 mt-1 mb-6">Complete your profile to be paired with a local club president.</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full mt-2 py-3.5 rounded-xl bg-gradient-to-r from-[#D91B5C] to-[#A70C43] hover:brightness-110 active:scale-[0.99] text-white font-bold text-xs sm:text-sm shadow-lg shadow-[#D91B5C]/30 flex items-center justify-center gap-2 transition disabled:opacity-50"
                >
                  {isSubmitting ? (
