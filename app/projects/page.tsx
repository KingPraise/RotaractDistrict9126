...
const projectsData: Project[] = [
  ...
  },
  {
    ...
    year: '2023',
    club: 'D9126 Joint Project',
    location: 'District 9126 · 7 States',
    image: 'https://images.unsplash.com/photo-1599059813005-11265ba4b4ce?w=900&h=700&fit=crop&auto=format',
    height: 'h-[380px]',
    stats: [
      { icon: 'heart', value: '18,000', label: 'Meals Served' },
      { icon: 'users', value: '620', label: 'Families Supported' },
      { icon: 'zap', value: '6', label: 'Distribution Hubs' }
    ]
  },
  {
    id: '6',
    title: 'SheLeads Mentorship',
    category: 'Empowerment',
    year: '2024',
    club: 'Rotaract Club of Ogbomoso',
    location: 'Ogbomoso, Oyo State',
    image: 'https://images.unsplash.com/photo-1607748862156-7c548e7e98f4?w=900&h=600&fit=crop&auto=format',
    height: 'h-[280px]',
    stats: [
      { icon: 'users', value: '300', label: 'Women Mentored' },
      { icon: 'zap', value: '45', label: 'Businesses Launched' },
      { icon: 'book', value: '12', label: 'Workshops Held' }
    ]
  },
  {
    id: '7',
...
const categoryColors: Record<string, { bg: string; border: string; text: string }> = {
  ...
  Environment: { bg: 'rgba(27, 217, 92, 0.133)', border: 'rgba(27, 217, 92, 0.267)', text: '#1BD95C' },
  'Food Security': { bg: 'rgba(217, 160, 27, 0.133)', border: 'rgba(217, 160, 27, 0.267)', text: '#D9A01B' },
  Empowerment: { bg: 'rgba(217, 27, 92, 0.133)', border: 'rgba(217, 27, 92, 0.267)', text: '#D91B5C' },
};
...
export default function ProjectsPage() {
  ...
  const renderIcon = (iconName: string, color: string) => {
    switch (iconName) {
      ...
      case 'zap': return <Zap color={color} size={12} />;
          ...
          <div className="relative w-full overflow-hidden" style={{ perspective: '1200px' }}>
            ...
            <div className="flex items-center justify-center gap-5 mt-6">
              <button 
                ...
                className="w-10 h-10 rounded-full flex items-center justify-center text-black/60 hover:text-black border border-black/10 hover:border-black/30 transition-all hover:bg-black/5"
              >
            ...
            <div className="flex items-center gap-2 flex-wrap font-sans">
              {categories.map((cat) => (
                <button
                  ...
                  className={`shrink-0 px-3 py-1 rounded-lg font-semibold uppercase tracking-wider text-[10.5px] transition-all ${
