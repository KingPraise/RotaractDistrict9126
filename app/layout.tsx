...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'Join Rotaract Club',
    'Rotary Foundation Nigeria',
    'DRR Adaramoye Iyanuoluwa',
  ],
  alternates: {
    canonical: '/',
  },
  openGraph: {
    title: 'Rotaract District 9126 — Fellowship. Service. Impact.',
    description:
      'Uniting 77 chartered clubs and 700+ young leaders across South-West & North-Central Nigeria for community transformation and humanitarian service.',
  ...
  twitter: {
    ...
    description:
      'Official platform uniting 77 clubs and 700+ young leaders across 7 Nigerian states in humanitarian impact.',
