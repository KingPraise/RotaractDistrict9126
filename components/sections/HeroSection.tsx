...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden flex flex-col justify-between bg-[#111111] pt-16">
      ...
      <motion.div 
        ...
        className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 pt-20 pb-12 text-center max-w-6xl mx-auto w-full my-auto"
      >
        
        <h1 className="font-black tracking-tighter mb-6 mt-8 font-sans leading-[1]">
          <motion.span 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7, delay: 0.1 }}
            className="block" 
            style={{ fontSize: 'clamp(3rem, 8vw, 7.5rem)', lineHeight: 0.95, color: 'rgb(255, 255, 255)', textShadow: 'rgba(0, 0, 0, 0.4) 0px 2px 40px' }}
          >
            Fellowship. Service.
          </motion.span>
          <motion.span 
            ...
            className="block" 
            style={{ fontSize: 'clamp(1.68rem, 4.5vw, 4.2rem)', lineHeight: 1.1, color: 'rgb(248, 113, 113)', textShadow: 'rgba(0, 0, 0, 0.35) 0px 2px 30px' }}
          >
            Impact.
          </motion.span>
        </h1>
        ...
        <motion.p 
          ...
          style={{ fontSize: 'clamp(1rem, 1.6vw, 1.2rem)', color: 'rgb(255, 255, 255)' }}
        >
        ...
        >
          <div style={{ animation: 'ctaPulse 3s ease-in-out infinite', borderRadius: '999px' }}>
            <a 
              href="/join" 
              className="inline-flex items-center gap-2 px-[26px] py-[10px] rounded-full bg-[#981132] font-sans text-[16px] font-bold text-white tracking-[0.02em] whitespace-nowrap transition-all duration-200 hover:scale-105 active:scale-95 group shadow-lg" 
          ...
          <a 
            href="/#impact" 
            className="flex items-center gap-2 px-8 py-4 rounded-xl font-semibold text-white/70 hover:text-white border border-white/10 hover:border-white/20 transition-all duration-200 hover:bg-white/5 font-sans text-[1rem] hover:scale-105 active:scale-95"
          >
        ...
        <div 
          className="mt-10 flex flex-col items-center gap-2 text-white/30 cursor-pointer hover:text-white/60 transition-colors" 
          onClick={() => {
      ...
      <motion.div 
        ...
        className="relative z-10 w-full max-w-6xl mx-auto px-6 pb-6"
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px overflow-hidden rounded-2xl bg-white shadow-[0_8px_40px_rgba(0,0,0,0.25)] border border-black/5">
          ...
          <div className="flex flex-col items-center gap-2 px-6 py-6 hover:bg-gray-50/80 transition-all duration-300 md:border-r border-black/5 group">
            ...
            <span className="text-xs uppercase tracking-[0.2em] font-sans text-black font-bold">Active Clubs</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-2 px-6 py-6 hover:bg-gray-50/80 transition-all duration-300 md:border-r border-black/5 group">
            ...
            <span className="text-xs uppercase tracking-[0.2em] font-sans text-black font-bold">Rotaractors</span>
          </div>

          <div className="flex flex-col items-center gap-2 px-6 py-6 hover:bg-gray-50/80 transition-all duration-300 group">
            <span className="font-black tabular-nums font-sans text-[#D4A520] transition-transform duration-300 group-hover:scale-105" style={{ fontSize: 'clamp(2rem, 4vw, 3.5rem)', lineHeight: 1, textShadow: 'rgba(212, 165, 32, 0.35) 0px 0px 30px' }}>
              <CountUp end={50000} suffix="+" duration={2600} />
            </span>
            <span className="text-xs uppercase tracking-[0.2em] font-sans text-black font-bold">Beneficiaries</span>
          </div>
